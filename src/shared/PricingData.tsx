export const pricingPlans = [
    {
      ...
      title: "Starter",
      description: "Best for businesses, startups, personal brands or anyone getting online for the first time.",
      originalPrice: "₦350K",
      discount: "25%",
      price: "₦220K",
      features: [
    ...
    },
    {
      ...
      title: "Premium",
      description: "Includes everything in starter package plus online ordering, payments or booking functionality",
      originalPrice: "₦500K",
      discount: "17%",
      price: "₦340K",
      features: [
