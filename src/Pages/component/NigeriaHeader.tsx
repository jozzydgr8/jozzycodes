...
export const NigeriaHeader = ()=>{
  ...
  const loopTexts = t('nigeriaHeader.loopTexts', { returnObjects: true }) as string[];
    ...
    <div>
                ...
                <div className='headerWrite' style={{display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center',fontSize:"medium"}}>
                    ...
                    <div className="centerDiv">
                        ...
                        {t('nigeriaHeader.subtitle')}
                        <br /> <br />
                        {t('nigeriaHeader.wantToGiveShot')}
                        </p>
                        <div style={{display:"flex", justifyContent:"center"}} >
