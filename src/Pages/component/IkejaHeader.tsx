...
export const IkejaHeader = ()=>{
  ...
  const loopTexts = t('ikejaHeader.loopTexts', { returnObjects: true }) as string[];
    ...
    <div>
                ...
                <div className='headerWrite' style={{display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center',fontSize:"medium"}}>
                    ...
                    <div className="centerDiv">
                        ...
                        {t('ikejaHeader.subtitle')}
                        <br /> <br />
                        {t('ikejaHeader.wantToGiveShot')}
                        </p>
                        <div style={{display:"flex", justifyContent:"center"}} >
                            
                            <div className='row justify-content-center text-center'>
                            <a href='https://wa.link/ubp14t' target='_blank' rel='noreferrer' className='col-md-6' style={{marginBottom:'20px'}}>
                            <FlatButton className='btn-lg' title={t('ikejaHeader.ctaGetStarted')} />
                            </a>

                            <NavLink to={`${basePath}/website-for-your-business`} className='col-md-6'>
                            <FlatButton title={t('ikejaHeader.ctaViewPricing')} className='btnoutline btn-lg' />
