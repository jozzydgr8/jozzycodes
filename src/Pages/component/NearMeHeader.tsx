...
export const NearMeHeader = ()=>{
  ...
  const loopTexts = t('nearMeHeader.loopTexts', { returnObjects: true }) as string[];
    ...
    <div>
                ...
                <div className='headerWrite' style={{display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center',fontSize:"medium"}}>
                    ...
                    <div className="centerDiv">
                        ...
                        {t('nearMeHeader.subtitle')}
                        <br /> <br />
                        {t('nearMeHeader.wantToGiveShot')}
                        </p>
                        <div style={{display:"flex", justifyContent:"center"}} >
                            
                            <div className='row justify-content-center text-center'>
                            <a href='https://wa.link/ubp14t' target='_blank' rel='noreferrer' className='col-md-6' style={{marginBottom:'20px'}}>
                            <FlatButton className='btn-lg' title={t('nearMeHeader.ctaGetStarted')} />
                            </a>

                            <NavLink to={`${basePath}/pricing`} className='col-md-6'>
                            <FlatButton title={t('nearMeHeader.ctaViewPricing')} className='btnoutline btn-lg' />
